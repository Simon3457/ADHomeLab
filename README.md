  ...
  <ol>
    ...
    <li>Setup IP address for internal network
      <ol>
        ...
        <li>Right-click the internal network, click properties, double-click Internet Protocol Version 4</li>
...
<li><b>Create Users from PowerShell commands in Active Directory</b>
  <ol>
    ...
    <li>Once the script is done, leave the server running & we'll go to the next step</li>
  </ol>
</li>
<br />
<br />
